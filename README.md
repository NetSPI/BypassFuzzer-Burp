...
- **Sweep Mode:**
  ...
  - Uses a bounded, mile-wide/inch-deep probe set with a default cap of 140 probes per endpoint
...
Sweep does not run the full BypassFuzzer payload inventory. It uses a curated wordlist capped at 140 probes per endpoint by default. The bundled wordlist focuses on:
